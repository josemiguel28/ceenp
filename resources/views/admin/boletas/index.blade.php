<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <h1 class="font-semibold text-2xl">Boletas</h1>
        <p class="text-gray-500">Gestiona las boletas de los estudiantes desde aqui.</p>
                ...
                <div class="flex flex-col justify-between gap-8 mb-4 md:flex-row md:items-center">
                    <div class="mt-4">
                        ...
                        <p class="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
                            Estos son las boletas de los estudiantes registrados en el sistema.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="p-4 border-b border-blue-gray-50">
                                ...
                                <a href="{{ asset('storage/' . $boleta->archivo)}}"
                                   target="_blank"
                                   class="hover:underline px-2 py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap bg-blue-100 text-blue-900">
                                    Ver Boleta
                                </a>
                            </td>
                            ...
                            <td class="p-4 border-b border-blue-gray-50">
                                <p class="block font-sans text-sm antialiased font-normal leading-normal text-blue-gray-900">
                                    {{ $boleta->created_at->diffForHumans() }}
                                </p>
                            </td>
                            <td class="p-4 border-b border-blue-gray-50">
                                        ...
                                        type="submit">
                                            <span
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4"
                                                     viewBox="0 0 48 48">
                                                    <g fill="none" stroke="#dc2626" stroke-linejoin="round"
                                                       stroke-width="4">
            ...
            @push('scripts')
                <script>
                    function confirmDelete() {
                        return confirm('¿Estás seguro de que deseas eliminar esta boleta?');
                    }
                </script>
            @endpush
        </div>
