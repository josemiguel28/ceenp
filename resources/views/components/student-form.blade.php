        ...
        <div
            ...
            <div class="mt-2">
                <template x-for="item in selectedItems" :key="item.id">
                    <div class="inline-flex items-center bg-gray-100 text-black rounded-full px-3 py-1 mr-2 mb-2">
                        <span x-text="item.nombre"></span>
                        <button
                            type="button"
    ...
    <script>
        function dropdown({items, selectedItems = []}) {
            return {
                items,
                search: '',
                selectedItems, // Inicializa con las materias seleccionadas en la edición
                isOpen: false,
                get filteredItems() {
                    return this.search === ''
                        ? this.items
